...
import { AutoArchiveAutomation, AutoArchiveCancelledAutomation, AutoCloseAutomation } from "@/components/automation";
    ...
    <SettingsContentWrapper header={<AutomationsProjectSettingsHeader />} hugging>
      ...
      <section className={`w-full ${canPerformProjectAdminActions ? "" : "opacity-60"}`}>
        ...
        <div className="mt-6">
          ...
          <AutoArchiveCancelledAutomation handleChange={handleChange} />
